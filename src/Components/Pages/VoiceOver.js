...
const VoiceOver = () => {
  ...
  return (
    ...
    <Container fluid className='website-design'>
      <Image src="services/voiceover.jpg" fluid alt="img" />
      <Container>
      <Row className='mt-5'>
        <Col md={6}>
          <Image src="https://media.istockphoto.com/vectors/business-promotion-campaign-vector-isometric-illustration-digital-vector-id1359842745?k=20&m=1359842745&s=612x612&w=0&h=qzyXTdX0JF7tYUgS-G-5IFDIMcncUHAFdby8to-5lBk=" data-aos='fade-right' data-aos-duration='1000'  />
        </Col>
        <Col md={6}>
          <h2 className='mt-5 mb-3'>Voice Over Service</h2>
          <p>Audiovisual forms are one of the most often sought and utilized resources. The enormous range of technical and creative possibilities they offer make them the ideal way to transmit the message you want to give your target audience, whether it's to inform, entertain, or teach. We want to underline the importance of finding your business voice, which should be in the most appropriate style, tone, and register to represent you, just as your company logo or motto does.</p>
        </Col>
      </Row>
      </Container>
<br></br>
