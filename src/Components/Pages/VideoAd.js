...
const VoiceOver = () => {
  ...
  return (
    ...
    <Container fluid className='website-design'>
      <Image src="services/advideo.jpg" fluid alt="img" />
      <Container>
      <Row className='mt-5'>
        <Col md={6}>
          <Image src="https://ecliqs.com/wp-content/uploads/2020/12/Video.png" data-aos='fade-right' data-aos-duration='1000'  />
        </Col>
        <Col md={6}>
          <h2 className='mt-5 mb-3'>Advertising Video</h2>
          <p>Digicircal advertising agency can help you take your brand to the next level with eye-catching adverts. We help you grow your business by increasing brand recognition and increasing revenue using proven methods. Our professionals precisely develop your visuals and place them in the spotlight for maximum exposure to potential prospects. All of these procedures are based on your specifications, which may include customizing the area, district, state, or country. With new concepts that effortlessly attract your target consumers, we provide you with long-term growth.</p>
        </Col>
      </Row>
      </Container>
<br></br>
