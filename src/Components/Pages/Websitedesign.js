...
const Websitedesign = () => {
  ...
  return (
    ...
    <Container fluid className='website-design'>
      <Image src="services/websitedesigning.jpg" fluid alt="img" />
      <Container>
      <Row className='mt-5'>
        <Col md={6}>
          <Image src="https://i.pinimg.com/originals/ab/28/6b/ab286b43dad5d7d542199f4365821e3d.gif" data-aos='fade-right' data-aos-duration='1000'  />
        </Col>
        <Col md={6}>
          <h2 className='mt-5 mb-3'>Website Designing</h2>
          <p>Creating a website that is simple to use, access, and read across all devices and platforms is an important aspect of creating your brand. A responsive website is created for a brand so that your customers can easily view all of your content, which is automatically adjusted for devices such as smartphones, iPads, iPhones, and notebooks. Although time-consuming, responsive web design and development is extremely cost-effective and will easily fit into your budget.</p>
        </Col>
      </Row>
      </Container>
      <div class="seven">
  <h1 className='text-center fw-bold mt-5 '>What <span>Website Designing</span> Includes?</h1>
    <Container className='mt-5'>
      <Row>
        ...
        <Col sm={3}>
          <p><span className='text-bold text-success'><i className='fas fa-check me-2' /></span> E-Commerce Website</p>
        </Col>
        <Col sm={3}>
          <p><span className='text-bold text-success'><i className='fas fa-check me-2' /></span> Portfolio Website</p>
        </Col>
        <Col sm={3}>
          <p><span className='text-bold text-success'><i className='fas fa-check me-2' /></span> Landing Page</p>
        </Col>
      </Row>
    </Container>
</div>
