...
const ContentWriting = () => {
  ...
  return (
    ...
    <Container fluid className='website-design'>
      <Image src="services/contentwriting.jpg" fluid alt="img" />
      <Container>
      <Row className='mt-5'>
        <Col md={6}>
          <Image src="https://media.istockphoto.com/vectors/people-vector-illustration-flat-cartoon-character-landing-page-vector-id1138075339?k=20&m=1138075339&s=612x612&w=0&h=kX5mT-edFFZMQxaJJVp_KGid5mrkPattj4t97yTUHTQ=" data-aos='fade-right' data-aos-duration='1000'  />
        </Col>
        <Col md={6}>
          <h2 className='mt-5 mb-3'>Content Writing</h2>
          <p>Content has a tremendous ability to attract readers and turn a firm into a brand. Our team of content experts provides end-to-end solutions, from content planning to developing good, well-optimized material and distributing it through various channels. To generate the desired conversions, we fill the gaps in the material available in the conversion route for our brand.
</p>
        </Col>
      </Row>
      </Container>
